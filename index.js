...
const clickOnImg = function(event){
event.preventDefault();
const eveTarg = event.target

if(eveTarg.nodeName === 'IMG'){
  refs.lightboxImages.src = eveTarg.dataset.source;
...
document.addEventListener('click', clickOnImg)
